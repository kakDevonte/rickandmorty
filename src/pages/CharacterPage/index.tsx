    ...
    return (
        <div className={styles.root}>
            ...
            <div className={styles.name}>
                ...
                <p>{currCharacter.status} - {currCharacter.species}</p>
                <NavLink to={`/location/${getLocationIdInUrl(currCharacter.origin.url)}`}
            ...
            <div className={styles.locations}>
                <NavLink to={`/location/${getLocationIdInUrl(currCharacter.location.url)}`}>
                    <h2>Locations: {currCharacter.location.name}</h2></NavLink>
            </div>
        </div>
    );
};